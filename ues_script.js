    ...
    L.geoJSON(geojsonData, {
        onEachFeature: function (feature, layer) {
            if (feature.properties) {
                ...
                popupContent += `<p>Architectural Style: ${feature.properties.style_prim}</p>`;
                popupContent += `<p>url: <a href="${feature.properties.url}" target="_blank">${feature.properties.url}</a></p>`;
...
if (typeof ues70nyc !== 'undefined') {
    ...
    uesMap.setView([40.76980660705194, -73.96577868092406], 14);
...
// Example marker
const e77Park = L.marker([40.76980660705194, -73.96577868092406])
    .bindPopup('31 East 69th Street');
...
var latlngs = [
    [40.764651053503634, -73.9674531150217], // 119-121 East 62nd Street/  Bulgarian Consulate-General
    ...
    [40.77523127789917, -73.96391005661201], // 10 East 77th Street / India UN Mission; and Myanmar
];
